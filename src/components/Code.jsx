...
export default function Codee() {
  return (<div name='source'>
   ...
   <div className='flex flex-col-row  '>
            <h6 className='flex mx-10'> < a href='https://www.linkedin.com/in/alphaousmane-diallo-5ab82b262'>linkedIn<FaLinkedin size={100}/></a><br/><br/></h6>
            <h6 className='flex mx-10'><a href='mailto:alphaousmaneousmane@gmail.com'><span>Mail</span> <MdContactMail size={100}/></a><br/><br/> </h6>
            <h6 className='flex mx-10'> <a href='https://call.whatsapp.com/voice/6BltD24KmGj7ymIleODD5N'><span>Watchapp</span> <AiOutlineWhatsApp size={100}/></a> <br/><br/></h6>
    </div>
    </div>
    </div>
    </div>
